...
namespace Seleccion_de_futbol
{
    class SeleccionPais : SeleccionDeFutbol
    {
        ...
        {
            if (c.GetType().Name == "Entrenador" && numeroEntrenadores > 0)
            {
                numeroEntrenadores--;
            ...
            else if (c.GetType().Name == "Masajista" && numeroMasajistas > 0)
            {
                numeroMasajistas--;
                seleccionPais.Remove(c);
            ...
            else if (c.GetType().Name == "Futbolista" && numeroFutbolistas > 0)
            {
                numeroFutbolistas--;
                seleccionPais.Remove(c);
            ...
            Console.WriteLine("No se ningun " + c.GetType().Name + "s en la seleccion");
            return false;
        }
